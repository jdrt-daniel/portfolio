  ...
  return (
    <div>
      <div className="">
        ...
        <p className="mt-2">My key skills include:</p>
      </div>
      <div className="ml-2">
        <h5 className="text-md font-semibold text-left mt-4">* Frontend</h5>
        <div className="flex flex-wrap gap-2 my-2">
          {frontedSkills.map((skill) => (
            <Badge key={skill}>{skill}</Badge>
          ))}
        </div>
      </div>
      <div className="ml-2">
        <h5 className="text-md font-semibold text-left mt-4">* Backend</h5>
        <div className="flex flex-wrap gap-2 my-2">
      ...
      <div className="ml-2">
        <h5 className="text-md font-semibold text-left mt-4">* Soft skills</h5>
        <div className="flex flex-wrap gap-2 my-2">
